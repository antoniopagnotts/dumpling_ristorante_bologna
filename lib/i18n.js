export const translations = {
  en: {
    ...
    menuPage: {
      title: "Our Menu",
      subtitle: "Every dish hand-folded with love and a sprinkle of manga magic.",
      allergensLabel: "Allergens",
      noItems: "No dishes available right now.",
      loading: "Loading menu…",
    },
    contacts: {
      title: "Say Hello!",
      subtitle:
        "Got a craving? A question? Just want to talk about dumplings? We\u2019re all ears (and stomachs). Drop us a line!",
      findUs: "Find Us",
      addressName: "Dumpling Bologna",
      addressLine1: "Via Aurelio Saffi, 24/f",
      addressLine2: "40131 Bologna BO, Italy",
      phone: "+39 051 003 0074",
      email: "ciao@dumplingbologna.it",
      followFlavor: "Follow the Flavor",
      form: {
        name: "Your Name",
        namePlaceholder: "Totoro",
        email: "Email Address",
        emailPlaceholder: "hungry@spirit.com",
        subject: "Subject",
        subjectOptions: [
          { value: "reservation", label: "Reservation Inquiry" },
          { value: "catering", label: "Catering Request" },
          { value: "feedback", label: "Love Letter (Feedback)" },
  ...
  it: {
    ...
    menuPage: {
      ...
      subtitle: "Ogni piatto piegato a mano con amore e un pizzico di magia manga.",
      allergensLabel: "Allergeni",
      noItems: "Nessun piatto disponibile al momento.",
      loading: "Caricamento menu…",
    },
    contacts: {
      title: "Ciao!",
      subtitle:
        "Hai un\u2019acquolina? Una domanda? Vuoi solo parlare di dumpling? Siamo tutt\u2019orecchi (e stomaci). Scrivici!",
      findUs: "Trovaci",
      addressName: "Dumpling Bologna",
      addressLine1: "Via Aurelio Saffi, 24/f",
      addressLine2: "40131 Bologna BO, Italia",
      phone: "+39 051 003 0074",
      email: "ciao@dumplingbologna.it",
      followFlavor: "Seguici",
      form: {
        name: "Il tuo nome",
        namePlaceholder: "Totoro",
        email: "Indirizzo email",
        emailPlaceholder: "affamato@spirito.com",
        subject: "Oggetto",
        subjectOptions: [
          { value: "reservation", label: "Prenotazione" },
          { value: "catering", label: "Richiesta catering" },
          { value: "feedback", label: "Lettera d\u2019amore (Feedback)" },
          { value: "other", label: "Solo per salutare!" },
        ],
